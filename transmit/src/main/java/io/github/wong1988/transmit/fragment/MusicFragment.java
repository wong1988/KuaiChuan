...
public class MusicFragment extends BaseListFragment<FileInfo, OtherFileAdapter> {

    private RecyclerView rv;

    private final BasicFileSelector.SelectorListener2 listener;

    public MusicFragment(BasicFileSelector.SelectorListener2 listener) {
    ...
    protected void requestData(int page) {
        ...
        }).execute(MediaCenter.AUDIO_EXTENSIONS);
    }
}